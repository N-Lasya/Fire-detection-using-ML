...
def send_mail_function():
    ...
    recipientmail1 = "add recipientmail1"
    # recipients mail
    recipientmail2 = "add recipientmail2"
    # recipients mail
    recipientmail1 = recipientmail1.lower()
    # To lower case mail
    recipientmail2 = recipientmail2.lower()
    # To lower case mail
    ...
    try:
        ...
        server.sendmail('addrecipient1mail', recipientmail1, "EMERGENCY!!!\n\nIMMEDIATE ACTION REQUIRED!!!\n\nFire accident has been reported\n\n\nAddress:")
        # recipients mail with mail message
        server.sendmail('addrecepient2mail', recipientmail2, "EMERGENCY!!!\n\nIMMEDIATE ACTION REQUIRED!!!\n\nFire accident has been reported\n\n\nAddress:")
        # recipients mail with mail message
        print("Alert mail sent sucesfully to {}".format(recipientmail1))
        # to print in console to whom mail is sent
        print("Alert mail sent sucesfully to {}".format(recipientmail2))
        # to print in console to whom mail is sent
        server.close()
        ## To close server
